                    ...
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="row">
                          ...
                          <div class="row">
                            <div
                              class="col-lg-7 col-md-9 col-12 order-2 order-md-1 pt-md-9"
                            >
                        ...
                        <div class="col-4">
                          <div class="d-flex gap-2 align-items-center mb-2">
                            <span class="badge bg-label-info p-1 rounded"
                              ><i class="ti ti-shopping-cart ti-sm"></i></span>
                            <p class="mb-0">Order</p>
                          </div>
                        ...
                        <div class="col-4 text-end">
                          ...
                          >
                            ...
                            <span class="badge bg-label-primary p-1 rounded"
                              ><i class="ti ti-link ti-sm"></i></span>
                          </div>
                    ...
                    <div class="card-body">
                      <div class="row align-items-center g-md-8">
                        <div class="col-12 col-md-5 d-flex flex-column">
                          <div
                            class="d-flex gap-2 align-items-center mb-3 flex-wrap"
                          >
                          ...
                          <small class="text-body"
                            >You informed of this week compared to last
                            week</small>
                        </div>
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body row">
                      <div class="col-12 col-sm-4 col-md-12 col-lg-4">
                        ...
                        <ul class="p-0 m-0">
                          <li
                            class="d-flex gap-4 align-items-center mb-lg-3 pb-1"
                          >
                  ...
                  <div class="card h-100">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-start my-4">
                        <div
                          class="badge rounded bg-label-primary p-2 me-4 rounded"
                        >
                      ...
                      <div class="d-flex align-items-start">
                        <div
                          class="badge rounded bg-label-secondary p-2 me-4 rounded"
                        >
                    ...
                    <div class="card-body">
                      <ul class="list-unstyled mb-0">
                        <li class="mb-6">
                          <div class="d-flex align-items-center">
                            <div
                              class="badge bg-label-secondary text-body p-2 me-4 rounded"
                            >
                              <i class="ti ti-shadow ti-md"></i>
                            </div>
                            <div
                              class="d-flex justify-content-between w-100 flex-wrap gap-2"
                            >
                              <div class="me-2">
                                <h6 class="mb-0">Direct Source</h6>
                                <small class="text-body"
                                  >Direct link click</small >
                              </div>
                              <div class="d-flex align-items-center">
                                <p class="mb-0">1.2k</p>
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            >
                              <div class="me-2">
                                ...
                                <small class="text-body"
                                  >Impact Radius Visits</small>
                              </div>
                              <div class="d-flex align-items-center">
                                <p class="mb-0">342</p>
                                <div class="ms-4 badge bg-label-danger">
                                  -0.4%
                                </div>
                              </div>
                            </div>
